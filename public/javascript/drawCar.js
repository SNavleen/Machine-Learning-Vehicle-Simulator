...
function drawCars() {
  ...
  socket.on('DumbCarArray', function(data) {
    ...
    for (var i = 0; i < data.length; i++) {
      var xPos = data[i]._xPos / 2000;
      var yPos = data[i]._yPos / 2000;
